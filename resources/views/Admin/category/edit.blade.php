                ...
                <div class="body">
                    <form action="{{route('categories.update',$category->id)}}" method="post">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="عنوان گروه" value="{{$category->name}}"                                    aria-describedby="basic-addon1">
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control" name="description" cols="10" rows="8" aria-label="با ناحیه متن">{{$category->description}}</textarea>
                        </div>
