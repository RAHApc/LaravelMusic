...
! function($) {
 ...
 /*--- Responsive Menu Start ----*/
		$("#toggle").on("click", function() {
            $("#sidebar").width(), 0 == $("#sidebar").offset().right ? $("#sidebar").animate({
                right: 500
            ...
            function checkRequire(formId, targetResp) {
                ...
                return target.find("input , textarea , select").each(function() {
                    if ($(this).hasClass("require")) {
                        if ("" == $(this).val().trim()) return check = 1, $(this).focus(), targetResp.html("فیلد مورد نظر را پر کنید."), $(this).addClass("error"), !1;
