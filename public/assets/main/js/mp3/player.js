...
// $.get('/music/Tracks',function(response){
//     var data=JSON.parse(response);
// var trackList = data.map(function(item){
//     return {
//         title: item.name,
//         artist:item.artist || 'ناشناخته',
//         mp3: item.file_url,
...
// ,{
//     title: "نام آهنگ",
//         artist: "نام هنرمند{#link7}",
//         mp3: "assets/js/mp3/browse/omid faghat sedam kon.mp3",
//         poster: "assets/js/mp3/browse/playlist-3.jpg"
// }
...
//         artist: item.artist || 'ناشناخته',
//         mp3: item.TrackFileUrl,
//         poster: item.TrackImageUrl
//     });
// }
