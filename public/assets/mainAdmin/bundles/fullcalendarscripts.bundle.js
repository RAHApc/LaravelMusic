! function (t, e) {
	...
	var Ht = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
		It = "ژانویه_فوریه_مارس_آوریل_مه_ژوئن_ژولای_آگوست_سپتامبر_اوکتبر_نوامبر_دسامبر".split("_"),
		xt = "ژان_فور_مار_آور_مه_ژوئن_ژول_آگو_سپت_اوک_نوا_دسا".split("_");
	...
	var Gt = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنجشنبه_جمعه_شنبه".split("_"),
		Ut = "یک_دو_سه_چهار_پنج_جمعه_شنبه".split("_"),
		Wt = "یک_دو_سه_چه_پن_جم_شن".split("_"),
		jt = st,
		qt = st,
		Zt = st;
...
function (t, e) {
	...
	return function (n) {
		...
		o.isPrimaryMouseButton = function (t) {
			...
			var n;
			return g(t) ? i.duration(t * e) : (n = t.asMonths(), 1 <= Math.abs(n) && D(n) ? i.duration({
				months: n * e
			}) : i.duration({
				days: t.asDays() * e
			}))
		...
		var r = n(2),
			...
			i = function (i) {
				...
				return r.__extends(t, i), t.prototype.renderBgRanges = function (t) {
					...
					for (n = 0; n < c; n++) {
						if (i = d[n], r = 0, o = y("<tr/>"), p.push([]), f.push([]), g.push([]), i)
